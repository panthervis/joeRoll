...
interface SimpleRewarderPerBlockInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleRewarderPerBlock extends Contract {
  ...
  interface: SimpleRewarderPerBlockInterface;
