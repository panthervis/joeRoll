...
interface IKashiPairInterface extends ethers.utils.Interface {
  functions: {
...
export class IKashiPair extends Contract {
  ...
  functions: {
    ...
    accrueInfo(
      ...
      [
        ...
        info: [BigNumber, BigNumber, BigNumber] & {
          interestPerSecond: BigNumber;
          lastAccrued: BigNumber;
          feesEarnedFraction: BigNumber;
        };
    ...
    totalAsset(
      ...
      [[BigNumber, BigNumber] & { elastic: BigNumber; base: BigNumber }] & {
        total: [BigNumber, BigNumber] & { elastic: BigNumber; base: BigNumber };
      }
    >;
