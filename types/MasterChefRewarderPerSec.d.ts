...
interface MasterChefRewarderPerSecInterface extends ethers.utils.Interface {
  functions: {
...
export class MasterChefRewarderPerSec extends Contract {
  ...
  interface: MasterChefRewarderPerSecInterface;
