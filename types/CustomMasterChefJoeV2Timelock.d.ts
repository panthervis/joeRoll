...
interface CustomMasterChefJoeV2TimelockInterface
  ...
  functions: {
    ...
    "devPercentLimit()": FunctionFragment;
    "executeTransaction(address,uint256,string,bytes,uint256)": FunctionFragment;
    "investorPercentLimit()": FunctionFragment;
    "joePerSecLimit()": FunctionFragment;
    ...
    "treasuryPercentLimit()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "devPercentLimit",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "investorPercentLimit",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "joePerSecLimit",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "treasuryPercentLimit",
    values?: undefined
  ): string;
...
export class CustomMasterChefJoeV2Timelock extends Contract {
  ...
  functions: {
    ...
    devPercentLimit(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    investorPercentLimit(overrides?: CallOverrides): Promise<[BigNumber]>;

    "investorPercentLimit()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    joePerSecLimit(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    treasuryPercentLimit(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    devPercentLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    joePerSecLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;
