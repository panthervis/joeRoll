...
interface MasterChefPerSecInterface extends ethers.utils.Interface {
  functions: {
...
export class MasterChefPerSec extends Contract {
  ...
  interface: MasterChefPerSecInterface;
  ...
  functions: {
    ...
    sushiPerSec(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    sushiPerSec(overrides?: CallOverrides): Promise<PopulatedTransaction>;
